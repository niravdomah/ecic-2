...
Validates that all 5 quality gates pass before committing and pushing to main. Runs automated checks, prompts for manual verification, and generates a report with remediation steps for failures.
...
After all gates pass, commit and update workflow state:
